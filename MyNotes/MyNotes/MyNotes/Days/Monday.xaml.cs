...
namespace MyNotes.Days
{
    ...
    public partial class Monday : ContentPage
    {
            ...
            get
            {
                if (database == null)
                {
                    database = new NotesDatabase(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder
                        .LocalApplicationData), "MondayNotes.db3"));
                }
                return database;
            }
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            var notes = await Monday.Database.GetNotesAsync();
            ...
            MyNotifications.GenerateNotifications("Monday");
        ...
        async void AddNoteClicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(noteText.Text))
            {
                ...
                await Monday.Database.SaveNoteAsync(new Note
                {
