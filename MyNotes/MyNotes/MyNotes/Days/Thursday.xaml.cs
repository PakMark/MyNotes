...
namespace MyNotes.Days
{
    ...
    public partial class Thursday : ContentPage
    {
            ...
            get
            {
                if (database == null)
                {
                    database = new NotesDatabase(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder
                        .LocalApplicationData), "ThursdayNotes.db3"));
                }
                return database;
            }
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            var notes = await Thursday.Database.GetNotesAsync();
            ...
            MyNotifications.GenerateNotifications("Thursday");
        ...
        async void AddNoteClicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(noteText.Text))
            {
                ...
                await Thursday.Database.SaveNoteAsync(new Note
                {
