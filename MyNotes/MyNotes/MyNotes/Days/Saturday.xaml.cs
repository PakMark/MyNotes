...
namespace MyNotes.Days
{
    ...
    public partial class Saturday : ContentPage
    {
            ...
            get
            {
                if (database == null)
                {
                    database = new NotesDatabase(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder
                        .LocalApplicationData), "SaturdayNotes.db3"));
                }
                return database;
            }
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            var notes = await Saturday.Database.GetNotesAsync();
            ...
            MyNotifications.GenerateNotifications("Saturday");
        ...
        async void AddNoteClicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(noteText.Text))
            {
                ...
                await Saturday.Database.SaveNoteAsync(new Note
                {
