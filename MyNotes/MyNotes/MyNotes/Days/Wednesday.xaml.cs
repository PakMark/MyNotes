...
namespace MyNotes.Days
{
    ...
    public partial class Wednesday : ContentPage
    {
            ...
            get
            {
                if (database == null)
                {
                    database = new NotesDatabase(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder
                        .LocalApplicationData), "WednesdayNotes.db3"));
                }
                return database;
            }
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            var notes = await Wednesday.Database.GetNotesAsync();
            ...
            MyNotifications.GenerateNotifications("Wednesday");
        ...
        async void AddNoteClicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(noteText.Text))
            {
                ...
                await Wednesday.Database.SaveNoteAsync(new Note
                {
